...
class Gamelist extends React.Component {
    ...
    render() {
        ...
        //Games that you have just opened
        ...
        for (var key of Object.keys(filteredGames)) {
            let gameCode = filteredGames[key].gameCode;
            if (recentGamesCodes.indexOf(gameCode) >= 0) {
                recentGames.push(
                    <SingleGame
                        isLimited={false}
                        key={c}
        ...
        return (
            <div>
                ...
                <div className="pageDiv">
                    ...
                    <br />
                    <div>
                        <h1 className="pageHeader">Your Games </h1>
                        <br />
                        <i>Hi {this.state.username}!</i>
                        <br />
                        <br />
                        <Link to={'/admin/newgame/'}>
                            <button
                    ...
                    {games.length + recentGames.length === 0 &&
                    !this.state.waiting ? (
                        <div style={listStyle}>
                            <br></br>
                        ...
                        <div style={listStyle}>
                            ...
                            {games.length > 0 ? (
                                <>
                                    <h1 className="titleStyle3">Other</h1>
                                    <br />
                                    {games}
                                </>
                            ) : null}
